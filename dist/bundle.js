			...
			domLoaded: {
				value: function domLoaded() {
					...
					this.HammerManager = new Hammer.Manager(document.body, {
						recognizers: [[Hammer.Pan], [Hammer.Press], [Hammer.Rotate], [Hammer.Pinch, { enable: false }, ["rotate"]], [Hammer.Swipe]]
					});
	
					this.HammerManager.on("pan press pinch swipe rotate", function (e) {
						console.log(e);
					});
				}
			}
